...
func (c *Client) CreateSource(ctx context.Context, input SourceRequest) (out Source, err error) {
	if !wireID(input.ID) || !wireID(input.Connection) {
		return out, errors.New("chartworks: invalid source identifier")
	}
	err = c.call(ctx, "POST", "/v1/sources", "", input, &out)
	return out, err
}

// Sources lists only server-authorized registrations and never tests warehouse connections.
func (c *Client) Sources(ctx context.Context) (out []Source, err error) {
...
func (c *Client) Source(ctx context.Context, id string) (out Source, err error) {
	...
	err = c.call(ctx, "GET", "/v1/sources/"+id, "", nil, &out)
	return out, err
}
...
func (c *Client) TestSource(ctx context.Context, id string) (out SourceStatus, err error) {
	...
	err = c.call(ctx, "POST", "/v1/sources/"+id+"/test", "", struct{}{}, &out)
	return out, err
}
...
func (c *Client) DiscoverSource(ctx context.Context, id string) (out SourceSchema, err error) {
	...
	err = c.call(ctx, "GET", "/v1/sources/"+id+"/schema", "", nil, &out)
	return out, err
}
...
func (c *Client) RotateSource(ctx context.Context, id string, expected int64) (out Source, err error) {
	if !wireID(id) || expected < 1 {
		return out, errors.New("chartworks: invalid source revision")
	}
	err = c.call(ctx, "POST", "/v1/sources/"+id+"/rotate", "", struct {
...
func (c *Client) ValidateRead(ctx context.Context, id string, input ReadValidationRequest) (out ReadValidationReceipt, err error) {
	if !wireID(id) || !wireID(input.Context) {
		return out, errors.New("chartworks: invalid source context")
	}
	if input.Parameters == nil {
		input.Parameters = []ReadParameter{}
	}
	err = c.call(ctx, "POST", "/v1/sources/"+id+"/validate", "", input, &out)
	return out, err
}
