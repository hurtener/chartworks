...
func cw01MigrationAcceptance(t *testing.T) {
	...
	if count(t, connection, `SELECT count(*) FROM chartworks.schema_migrations`) != 43 {
		t.Fatal("upgrade did not apply exactly eight new migrations")
	}
