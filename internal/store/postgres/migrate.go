...
func requiredRelations(ctx context.Context, tx pgx.Tx) error {
	relations := []string{
		...
		"document_deletion_tombstones", "evaluation_feedback_exports", "evaluation_inputs", "evaluation_pack_selection", "evaluation_proposals", "evaluation_runs", "evaluation_suites",
	}
	var count int
