...
func httpFault(err error) (int, string) {
	...
	case errors.Is(err, semantics.ErrInvalid), errors.Is(err, engineering.ErrInvalid), errors.Is(err, jobs.ErrInvalid), errors.Is(err, reporting.ErrInvalid), errors.Is(err, rendering.ErrInvalid), errors.Is(err, store.ErrInvalid), errors.Is(err, nlqexec.ErrInvalid):
