...
| `mcp.groups` | string array | discovery, query, byo, charts, reporting, onboarding, migration | 1–7 distinct implemented group names. Only installed services are exposed; selecting no real bindings fails startup. |
...
|---|---|---|
| `mcp.groups` | Array; discovery, query, byo, charts, reporting, onboarding, migration | 1–7 distinct implemented names. The reporting, onboarding and migration groups register real services only; `features.mcp` still defaults false. |
