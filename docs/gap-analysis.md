...
| RTE-01, RTE-02, LRN-01, LRN-02, CLR-01, CLR-02 | **Learning gaps implemented; routing/interpretation gaps remain.** | CW-08 adds reviewed exact-origin retrieval candidates, deterministic precedence, selection provenance and bounded positive/negative evidence. Phase 24 still owns live calibration and decay evaluation. Caller topic selection, hit-distance confidence and remaining interpretation gaps remain. [learning contract](contracts/learning-lifecycle-v1.md), [route boundary](../internal/nlqroute/service.go) |
