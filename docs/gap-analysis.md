...
| LRN-01, LRN-02, CLR-01, CLR-02, RUL-01 | **Learning and rule-scope gaps remain; clarification is implemented by CW-01.** | Template lifecycle, evidence-aware feedback and compound/template rule scopes remain separate work. Conditional typed clarification is now implemented; its representative-user comprehension study remains unperformed. [clarification contract](contracts/conditional-clarification-v1.md), [rules](../internal/semantics/rules.go) |
