...
Phases **01–22 are shipped**. Phases 23, 26, 27, 28 and 29 are in progress;
the remaining seven workstreams are planned, including the phase-25 final release
gate. The registry maps 172 criteria to implemented or in-progress work. This is
...
[phase-29 review](../reviews/phase-29-adversarial.md) record verification
