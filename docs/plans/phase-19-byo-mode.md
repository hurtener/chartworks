...
Opaque context reference has no authority independent of the current JWT. D-052 supersedes local signed-handle machinery. No runtime completion is claimed.
