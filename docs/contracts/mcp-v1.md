...
composition with all implemented services has thirty-five bindings:
...
absent when its routing service is unavailable. Later installed reporting and
migration services extend this generated inventory; disabled or unavailable
services never advertise bindings.
